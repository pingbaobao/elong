...
//   req.body.hotelImage = '/uploads/images/' + _filename;
...
//     cb(_flag?null:new Error('请上传正确的图片格式'),_flag);
// }
// var upload = multer({ storage, fileFilter }).single('hotelImage') // .single处理单文件上层
